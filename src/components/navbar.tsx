      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <ul className="flex text-white/80 items-center absolute left-1/2 transform -translate-x-1/2">
            <li><NavItem href="#about" Icon={UserIcon}>About</NavItem></li>
            <li><NavItem href="#skills" Icon={CodeBracketIcon}>Skills</NavItem></li>
            <li><NavItem href="#experience" Icon={BriefcaseIcon}>Experience</NavItem></li>
            <li><NavItem href="#projects" Icon={SparklesIcon}>Projects</NavItem></li>
            <li><NavItem href="#blogs" Icon={PencilIcon}>Blogs</NavItem></li>
          </ul>
